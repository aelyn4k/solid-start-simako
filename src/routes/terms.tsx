        ...
        <div class="layout-shell grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-start">
          <div>
            ...
            <p class="ui-lead mt-5 max-w-2xl leading-8">
              Dengan menggunakan SIMAKO, pengguna menyetujui ketentuan layanan
              untuk pencarian kamar, pendaftaran akun, komunikasi dengan
          ...
          <div class="surface-card p-6">
            ...
            <p class="ui-text mt-3 leading-7">
              Gunakan SIMAKO secara benar, jaga keamanan akun, dan pastikan
              setiap transaksi atau sewa dikonfirmasi dengan pihak pengelola.
            </p>
          </div>
        </div>
      </section>
        ...
        <div class="rounded-xl border border-red-400/30 bg-red-500/10 p-5">
          <div class="flex items-start gap-3">
            ...
            <p class="ui-text text-sm leading-7">
              Jika ada perbedaan informasi antara halaman SIMAKO dan konfirmasi
              langsung pengelola, gunakan konfirmasi terbaru dari pengelola
              sebagai acuan sebelum melakukan pembayaran atau sewa.
            </p>
          </div>
        </div>
