      ...
      <section class="surface-card auth-panel w-full max-w-lg p-6 text-center md:p-8">
        {confirmed() ? (
          <>
            ...
            <p class="ui-text mt-3 leading-7">Sesi akun telah diakhiri. Silakan masuk kembali untuk mengakses dashboard.</p>
          ...
          <>
            ...
            <h1 class="ui-heading mt-4 text-3xl font-bold">Yakin ingin keluar?</h1>
            <p class="ui-text mt-3 leading-7">
              Setiap tindakan logout perlu dikonfirmasi agar sesi tidak tertutup tanpa sengaja.
            </p>
            <div class="mt-7 grid gap-3 sm:grid-cols-2">
              <button type="button" class="btn-primary px-5 py-3 text-sm" onClick={() => setConfirmed(true)}>
                Ya, Logout
              </button>
              <button type="button" class="btn-secondary px-5 py-3 text-sm" onClick={cancelLogout}>
                Tidak
              </button>
            </div>
          </>
