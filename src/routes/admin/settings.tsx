...
export default function AdminSettingsRoute() {
  return (
    <Sidebar title="Settings" subtitle="Pengaturan akun admin untuk keamanan akses panel.">
      <section class="dashboard-card max-w-2xl p-6">
        <div class="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p class="dashboard-muted mt-1 text-sm">Gunakan password yang kuat untuk menjaga akses admin.</p>
          </div>
        </div>
        ...
        <form class="grid gap-4" onSubmit={(event) => event.preventDefault()}>
          <label class="block">
            ...
            <input class="form-control mt-2" type="password" placeholder="Masukkan password saat ini" />
          </label>
          <label class="block">
          ...
          <label class="block">
            ...
            <input class="form-control mt-2" type="password" placeholder="Ulangi password baru" />
          </label>
          <div class="pt-2">
